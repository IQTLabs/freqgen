...
describe('k-mer frequencies', function() {
  ...
  test('An object with different k values should not throw an error if validation is off', () => {
    ...
    ).toEqual(new Map(Object.entries({ A: 0.5, AA: 0.5 })))
  })
})
